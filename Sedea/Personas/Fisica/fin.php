...
if (is_numeric(!is_null($ApoyoEstatalSolicitado6)) & is_numeric(!is_null($ApoyoEstatalSolicitado6)) & is_numeric(!is_null($ApoyoEstatalSolicitado6)) ) {
	$InversionTotal6	=			$ApoyoEstatalSolicitado6 + $ApoyoMunicipalSolicitado6 + $AportacionBeneficiario6;
          ...
          $insert3 = "INSERT INTO personafisicaConceptoApoyo VALUES('{$folioImpreso}','{$ApoyoSolicitado3}','{$UniMedida3}','{$CanSolicitada3}','{$ApoyoEstatalSolicitado3}','{$ApoyoMunicipalSolicitado3}','{$AportacionBeneficiario3}','{$InversionTotal3}');";


          $insert4 = "INSERT INTO personafisicaConceptoApoyo VALUES('{$folioImpreso}','{$ApoyoSolicitado4}','{$UniMedida4}','{$CanSolicitada4}','{$ApoyoEstatalSolicitado4}','{$ApoyoMunicipalSolicitado4}','{$AportacionBeneficiario4}','{$InversionTotal4}');";
    
    
          $insert5 = "INSERT INTO personafisicaConceptoApoyo VALUES('{$folioImpreso}','{$ApoyoSolicitado5}','{$UniMedida5}','{$CanSolicitada5}','{$ApoyoEstatalSolicitado5}','{$ApoyoMunicipalSolicitado5}','{$AportacionBeneficiario5}','{$InversionTotal5}');";

          $insert6 = "INSERT INTO personafisicaConceptoApoyo VALUES('{$folioImpreso}','{$ApoyoSolicitado6}','{$UniMedida6}','{$CanSolicitada6}','{$ApoyoEstatalSolicitado6}','{$ApoyoMunicipalSolicitado6}','{$AportacionBeneficiario6}','{$InversionTotal6}');";


          */

          #Datos de Requisitos Generales 
          $InsertRequisitosG = "INSERT INTO  personafisicaReqenerales VALUES (null,'{$folioImpreso}',$Observaciones,curdate());";
           ...
           $InsertRequisitosG =     utf8_encode($InsertRequisitosG);
            ...
            echo "Datos registrados de requisitos";
            queryMySql($InsertRequisitosG);
            echo "Datos de requisitos generales";
